            ...
            <section className="max-w-4xl mx-auto animate-fade-in-up">
              <div className="rounded-2xl p-8 sm:p-12 shadow-lg text-center" style={{ background: 'linear-gradient(to bottom right, #1E5631, #163822)' }}>
                ...
                <div className="grid sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
                  <button
                    onClick={() => handleContactAction('youtube')}
                    className="bg-red-600 hover:bg-red-700 text-white px-8 py-6 rounded-2xl text-lg font-semibold transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-2xl flex flex-col items-center gap-3"
                  >
                    <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                    </svg>
                    <div>
                      <div className="font-bold text-xl mb-1">YouTube</div>
                      <div className="text-sm opacity-90">Watch Our Videos</div>
                    </div>
                  </button>

                  <button
                    onClick={() => handleContactAction('whatsapp')}
                    className="px-8 py-6 rounded-2xl text-lg font-semibold transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-2xl border-2 cursor-pointer flex flex-col items-center gap-3"
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-sm opacity-90">Join Community</div>
                    </div>
                  </button>
                </div>
              </div>
